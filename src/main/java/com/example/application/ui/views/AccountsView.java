 ...
 * Displays accounts in a hierarchical tree grid with CRUD operations.
 */
...
public class AccountsView extends VerticalLayout {
    ...
    private void configureGrid() {
        ...
        grid.addColumn(Account::getTaxDefaultCode)
            .setHeader("Tax Code")
            .setAutoWidth(true);
    ...
    private void loadAccounts() {
        ...
        List<Account> rootAccounts = allAccounts.stream()
    ...
    private void addChildrenRecursively(TreeData<Account> treeData, Account parent, List<Account> allAccounts) {
        List<Account> children = allAccounts.stream()
        ...
        saveButton.addClickListener(e -> {
            ...
            try {
                if (isNew) {
                    ...
                    newAccount.setAltCode(altCodeField.getValue().isBlank() ? null : altCodeField.getValue().trim());
                    ...
                    editAccount.setAltCode(altCodeField.getValue().isBlank() ? null : altCodeField.getValue().trim());
                    ...
                    Notification.show("Account updated successfully", 3000, Notification.Position.BOTTOM_START)
                        .addThemeVariants(NotificationVariant.LUMO_SUCCESS);
                }
    ...
    private void openAddChildDialog(Account parent) {
        ...
        saveButton.addClickListener(e -> {
            ...
            try {
                ...
                Notification.show("Child account created successfully", 3000, Notification.Position.BOTTOM_START)
                    .addThemeVariants(NotificationVariant.LUMO_SUCCESS);
